				...
				<div class="portlet paddingless">
						...
						<div class="tabbable tabbable-custom">
							<ul class="nav nav-tabs">
								<li class="active"><a href="" data-toggle="tab"
									id="relevanced" index="1">已关联商品</a></li>
								<li><a href="" data-toggle="tab" id="prerelevance"
									index="2">预关联商品</a></li>
					...
					<div class="row-fluid">
						...
						<div class="span6">
							...
							<button class="btn" id="again">再关联</button>
						</div>
								...
								for (var i = 0; i < pageBean.list.length; i++) {
									str += "<tr index='"+pageBean.list[i].id
										...
										str	+= "</td><td><input type='button' onclick='relevance("
											+ pageBean.list[i].id
											+ ")' value='预关联'data-target='#myModa4' data-toggle='modal' class='btn'/>"
											+ "</td><td>"
											+ "<div class='btn-group'><input type='button' onclick='relevance("
											+ pageBean.list[i].id
